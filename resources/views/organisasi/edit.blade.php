...
<div class="my-3 p-3 bg-body rounded shadow-sm">
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" name='tahun_awal' value="{{ $data->tahun_awal }}" id="tahun_awal">
        </div>
    </div>
    <div class="mb-3 row">
        <label for="tahun_akhir" class="col-sm-2 col-form-label">Tahun Akhir</label>
        <div class="col-sm-10">
            <input type="text" class="form-control" name='tahun_akhir' value="{{ $data->tahun_akhir }}" id="tahun_akhir">
        </div>
    </div>
    <div class="mb-3 row">
