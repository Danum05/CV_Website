...
<form action='{{ url('pendidikan_user/'.$data->identitas_id) }}' method='post' enctype="multipart/form-data">
@csrf 
@if($errors->any())
...
<a href='{{ url("pendidikan_user/{$data->identitas_id}") }}' class="btn btn-secondary"><< kembali</a>
        <div class="mb-3 row">
