...
<form action='{{ url('portofolio_user/'.$data->identitas_id) }}' method='post' enctype="multipart/form-data">
@csrf 
@if($errors->any())
...
<a href='{{ url("portofolio_user/{$data->identitas_id}") }}' class="btn btn-secondary"><< Kembali</a>
    <div class="mb-3 row">
